...
parser.add_argument("--lr1", type=float, default=0.001, help="adam: learning rate")
parser.add_argument("--lr2", type=float, default=0.002, help="adam: learning rate")
...
parser.add_argument("--n_classes", type=int, default=0, help="number of classes for dataset")
